...
<?php if (!empty($contentArr)): ?>
    <?php foreach ($contentArr as $item): ?>
        <swiper-slide style="min-height:380px; <?php echo !empty($item->background_color)?'background-color:'.$item->background_color : '';?>" >
